...
const city = getCityData('marrakech')!
...
const schema = {
  ...
  description: city.metaDescription,
  areaServed: { '@type': 'City', name: 'Marrakech', containedInPlace: { '@type': 'Country', name: 'Morocco' } },
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Logiciel Hostel Marrakech', item: 'https://www.sweetreservation.com/logiciel-hostel-marrakech' },
  ],
}
