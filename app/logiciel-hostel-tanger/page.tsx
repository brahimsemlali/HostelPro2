...
const schema = {
  ...
  description: city.metaDescription,
  areaServed: { '@type': 'City', name: 'Tanger', containedInPlace: { '@type': 'Country', name: 'Morocco' } },
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Logiciel Hostel Tanger', item: 'https://www.sweetreservation.com/logiciel-hostel-tanger' },
  ],
}
