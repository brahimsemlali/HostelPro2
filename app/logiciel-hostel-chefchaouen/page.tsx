...
const city = getCityData('chefchaouen')!
...
const schema = {
  ...
  description: city.metaDescription,
  areaServed: { '@type': 'City', name: 'Chefchaouen', containedInPlace: { '@type': 'Country', name: 'Morocco' } },
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Logiciel Hostel Chefchaouen', item: 'https://www.sweetreservation.com/logiciel-hostel-chefchaouen' },
  ],
}
