...
const city = getCityData('casablanca')!
...
const schema = {
  ...
  description: city.metaDescription,
  areaServed: { '@type': 'City', name: 'Casablanca', containedInPlace: { '@type': 'Country', name: 'Morocco' } },
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Logiciel Hostel Casablanca', item: 'https://www.sweetreservation.com/logiciel-hostel-casablanca' },
  ],
}
