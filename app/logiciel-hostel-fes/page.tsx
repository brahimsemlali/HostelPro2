...
const schema = {
  ...
  description: city.metaDescription,
  areaServed: { '@type': 'City', name: 'Fès', containedInPlace: { '@type': 'Country', name: 'Morocco' } },
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Logiciel Hostel Fès', item: 'https://www.sweetreservation.com/logiciel-hostel-fes' },
  ],
}
